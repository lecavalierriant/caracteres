...
majuscules["Modificatif"] = ["ᴬ", "ᴮ", minuscules["Modificatif"][2], "ᴰ", "ᴱ", "", "ᴳ", "ᴴ", "ᴵ", "ᴶ", "ᴷ", "ᴸ", "ᴹ", "ᴺ", "ᴼ", "ᴾ", minuscules["Modificatif"][16], "ᴿ", minuscules["Modificatif"][18], "ᵀ", "ᵁ", "ⱽ", "ᵂ", minuscules["Modificatif"][23], minuscules["Modificatif"][24], minuscules["Modificatif"][25]];
chiffres["Modificatif"] = ["⁰", "¹", "²", "³", "⁴", "⁵", "⁶", "⁷", "⁸", "⁹"];

minuscules["Indice"] = ["ₐ", minuscules["Normal"][1], minuscules["Normal"][2], minuscules["Normal"][3], "ₑ", minuscules["Normal"][5], minuscules["Normal"][6], "ₕ", "ᵢ", "ⱼ", "ₖ", "ₗ", "ₘ", "ₙ", "ₒ", "ₚ", minuscules["Normal"][16], "ᵣ", "ₛ", "ₜ", "ᵤ", "ᵥ", "ᵥᵥ", "ₓ", minuscules["Normal"][24], minuscules["Normal"][25]];
majuscules["Indice"] = minuscules["Indice"];
chiffres["Indice"] = ["₀", "₁", "₂", "₃", "₄", "₅", "₆", "₇", "₈", "₉"];
